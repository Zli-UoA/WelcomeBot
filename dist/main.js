...
var postChannelID = process.env.POST_CHANNEL_ID;
app.event('team_join', function (_a) {
  var event = _a.event,
      context = _a.context;
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4, app.client.chat.postMessage({
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4, app.start(process.env.PORT || 3000)];
